...
import Countries from '../../../common/api/test2/countriesApi.json';
...
const Profile = () => {
    ...
    const { test2Name } = useParams();
    const nation = Countries[test2Name];
            ...
            <div className={styles.wrapper} key={nation.id}>
                <div className={styles.container}>
                    ...
                    <div className={styles.button__box}>
                        ...
                        <Link to="/test2Home" className={styles.button}>
                            다시하기
                            <FontAwesomeIcon
                                icon={faSignOutAlt}
                                className={styles.icon}
